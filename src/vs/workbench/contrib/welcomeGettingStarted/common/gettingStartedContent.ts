...
export const startEntries: GettingStartedStartEntryContent = [
	{
		id: 'auraCodeSsh',
		title: localize('gettingStarted.auraCode.ssh.title', "Connect via SSH"),
		description: localize('gettingStarted.auraCode.ssh.description', "Connect to a remote SSH workspace."),
		when: '!isWeb',
		icon: Codicon.remote,
		content: {
			type: 'startEntry',
			command: 'command:remoteai.ssh.connectToHost',
		}
	},
	{
		id: 'auraCodeOpen',
		title: localize('gettingStarted.auraCode.open.title', "Open project"),
		description: localize('gettingStarted.auraCode.open.description', "Open a local file or folder."),
